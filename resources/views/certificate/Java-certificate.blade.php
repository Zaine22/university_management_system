        ...
        <div class="row pm-certificate-body">
            ...
            <div class="col-span-12">
              <div class="row">
                <div class="col-xs-2 pm-name-text">
                  ...
                  >
                  from Start Date to End Date and has been awarded this certificate of proficiency. The student has had a minimum of 140-hour hands-on experience. The following courses had successfully completed.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-2 section-text ">
            ...
            <div class="text-left whitespace-normal">
              ...
              <div>•	Data Types and Control Statements</div>
              <div>•	Objects, Class and Methods</div>
            ...
            <div class="text-left">
              ...
              <div>•	Database with Java (MySQL)</div>
              <div>•	GUI</div>
              <div>•	JDBC</div>
              <div>•	Project-based Assignments</div>
