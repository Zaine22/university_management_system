    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                ...
                <p>Welcome to {{ $enrollment->batch->batch_name }}! We are thrilled to have you on board and look
                    forward to guiding you through this excitinglearning journey.</p>
                <p>Choose RI for your Quality of Education! <br> Example</p>
            </div>
