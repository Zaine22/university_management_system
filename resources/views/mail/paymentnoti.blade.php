...
<body>
    ...
    <div class="container">
        ...
        <div>
            ...
            <p>We are pleased to inform you that your payment for {{ $payment->enrollment->batch->batch_name }} has been successfully processed. The paid amount is {{ $payment->payment_price }}. Let's embark on a successful journey together!</p>
